...
(
  ...
  '3-5 years', '20-32 LPA',
  'Build the seller-facing dashboard used daily by 100k+ merchants: shipment tracking, rate calculators, and bulk order flows. Performance and polish matter: the dashboard is the product for our sellers.',
...
(
  ...
  'Engineering leader with 15 years, currently Director at Flipkart running fulfilment-platform engineering: 4 EMs and 55 engineers across warehouse allocation, courier routing, and returns. Rebuilt the org after 40% attrition in 2023, rehiring to 55, cutting regretted attrition to 6%, and taking deploy frequency from fortnightly to daily behind a progressive-delivery platform. Earlier at Ola, scaled the marketplace pricing platform through 10x ride growth as Senior EM. Started as a consultant at ThoughtWorks. Chairs architecture council; still reviews critical designs personally.',
  'shortlisted'
);
...
(
  ...
  'Frontend Engineer, React at Shiprocket (Bengaluru, Hybrid). Build the seller dashboard used daily by 100k+ merchants: shipment tracking, rate calculators, and bulk order flows. Responsibilities: ship features across the dashboard (React 18, Next.js, TypeScript); own Core Web Vitals budgets and bundle discipline; build reusable components with the design-system team; write meaningful tests. Requirements: 3+ years production React/TypeScript; deep rendering-performance and state-management understanding; Next.js or similar SSR experience; track record of accessible, polished UI.',
